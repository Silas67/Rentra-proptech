    ...
    return (
      ...
      >
        <div className="relative w-fit overflow-hidden">
          <span className="flex items-center relative overflow-hidden  z-10">
            {children}
            {arrow && (
              <span className="inline-block transform -rotate-45 group-hover:rotate-0 transition-transform duration-300 ml-2">
                →
              </span>
            )}
