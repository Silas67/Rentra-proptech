          ...
          <div ref={logoRef} className="opacity-0 mb-16 md:mb-24">
            ...
            >
              <text
                ...
                textAnchor="middle"
                className="fill-softblack/90 Zina"
                style={{
                  fontSize: '90px',
            ...
            <div>
              ...
              {footerConfig.email && (
                <a
                  ...
                  className="text-xl md:text-2xl font-sans font-semibold text-softblack hover:text-softblack/70 transition-colors duration-300 group w-fit"
                >
                  {footerConfig.email}
                  <p className="w-full scale-x-0 group-hover:scale-x-100 border transition-all origin-left duration-300 border-forest-dark"></p>
                </a>
              )}
                ...
                <nav className="space-y-3">
                  {footerConfig.navLinks.map((link) => (
                    <a
                      key={link.label}
                      href={link.href}
                      className="block text-softblack/80 hover:text-softblack font-body transition-colors duration-300 group w-fit"
                    >
                      {link.label}
                      <p className="w-full scale-x-0 group-hover:scale-x-100 border transition-all origin-left duration-300 border-forest-dark"></p>
                    </a>
