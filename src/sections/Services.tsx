...
import { Camera, Diamond, Users, Sparkles, Home, Search, Shield, type LucideIcon } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-start">
          ...
          <div ref={headingRef} className="opacity-0">
            ...
            <Button variant="secondary" size="sm" className="mt-6 block" onClick={() => window.location.href = '/#contact'} arrow={true}>Browse Listings</Button>
          </div>
          ...
          <div ref={gridRef} className="grid grid-cols-1 sm:grid-cols-2 gap-px bg-white/10">
            {servicesConfig.services.map((service, index) => {
              ...
              return (
                ...
                >
                  <div className="mb-4">
                    <Icon className="w-8 h-8 text-white/70 group-hover:text-secondary transition-colors duration-300" strokeWidth={1.5} />
                  </div>
                  ...
                  <div className="mt-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300 ">
                    <svg
                      className="w-5 h-5 text-white/60 group-hover:text-secondary"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
