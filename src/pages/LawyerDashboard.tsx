...
const LawyerDashboard = () => {
  ...
  useEffect(() => {
    ...
    const load = async () => {
      setLoading(true);
      const verifications = await verificationService.listForLawyer(user.id);
  ...
  return (
    <div className="min-h-screen pt-24 pb-12">
      <div className="container max-w-3xl">
        <h1 className="font-display text-2xl font-bold mb-1">Lawyer Dashboard</h1>
        <p className="text-muted-foreground mb-6">Properties assigned to you for AGIS submission</p>
        ...
        {loading ? (
          ...
          <div className="rounded-xl border border-dashed bg-card p-12 text-center text-muted-foreground">
            ...
            <p className="font-medium">No AGIS requests assigned yet</p>
          </div>
        ) : (
